...
type InsightRepository interface {
	ListSales(ctx context.Context) ([]domain.Sale, error)
	ListSuggestions(ctx context.Context) ([]domain.Suggestion, error)
	ListComplaints(ctx context.Context) ([]domain.Complaint, error)
	ListUserCaptures(ctx context.Context) ([]domain.UserCapture, error)
}
...
func (s *MockStore) ListSales(ctx context.Context) ([]domain.Sale, error) {
	s.mu.RLock()
	defer s.mu.RUnlock()
...
func (s *MockStore) ListSuggestions(ctx context.Context) ([]domain.Suggestion, error) {
	s.mu.RLock()
	defer s.mu.RUnlock()
...
func (s *MockStore) ListComplaints(ctx context.Context) ([]domain.Complaint, error) {
	s.mu.RLock()
	defer s.mu.RUnlock()
...
func (s *MockStore) ListUserCaptures(ctx context.Context) ([]domain.UserCapture, error) {
	s.mu.RLock()
	defer s.mu.RUnlock()
